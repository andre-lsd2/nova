...
<extensions xmlns:atom="http://www.w3.org/2005/Atom" xmlns="http://docs.openstack.org/common/api/v1.0">
  ...
  <extension alias="os-change-instance-ownership" updated="%(timestamp)s" namespace="http://docs.ope
nstack.org/compute/ext/change-instance-ownership/api/v2" name="ChangeInstanceOwnership">
    <description>%(text)s</description>
  </extension>
</extensions>
